  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="max-w-full relative flex-shrink-0 px-8 py-6 mb-4"
            key={idx}
          >
            <div className="flex items-center justify-center  rounded-full text-5xl text-slate-200 shadow-lg">
              {item.icon}
            </div>
